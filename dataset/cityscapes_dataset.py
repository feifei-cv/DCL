...
class cityscapesDataSet(data.Dataset):
    ...
    def __init__(self, args, root, list_path, max_iters=None, set='val'):
        ...
        cityscape_transform_list = [joint_transforms3.RandomSizeAndCrop(args.input_size, False, pre_size=None,
                                                                        scale_min=0.5, scale_max=1.0, ignore_index=255),  ## scale：0.5-1.0
                                    joint_transforms3.Resize(args.input_size),
                                    joint_transforms3.RandomHorizontallyFlip()]
        self.joint_transform = joint_transforms3.Compose(cityscape_transform_list)
